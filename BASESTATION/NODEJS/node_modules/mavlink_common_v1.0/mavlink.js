...
Generated from: gardenbot.xml,common.xml
...
mavlink.MAVLINK_MSG_ID_DHT11_DATA = 150
mavlink.MAVLINK_MSG_ID_SABERTOOTH = 151
mavlink.MAVLINK_MSG_ID_VOLTAGECURRENT = 152
...
DHT11 Sensor Values
                ...
                temperature_celsius        : Temperatur (Celsius) (uint8_t)
                humidity_percent          : Humidity (Percent) (uint8_t)

*/
mavlink.messages.dht11_data = function(temperature_celsius, humidity_percent) {

    this.format = '<BB';
    this.id = mavlink.MAVLINK_MSG_ID_DHT11_DATA;
    this.order_map = [0, 1];
    this.crc_extra = 56;
    this.name = 'DHT11_DATA';

    this.fieldnames = ['temperature_celsius', 'humidity_percent'];
...
mavlink.messages.dht11_data.prototype = new mavlink.message;

mavlink.messages.dht11_data.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.temperature_celsius, this.humidity_percent]));
}
...
*/
mavlink.messages.sabertooth = function(drive, turn) {

    this.format = '<bb';
    this.id = mavlink.MAVLINK_MSG_ID_SABERTOOTH;
    this.order_map = [0, 1];
    this.crc_extra = 109;
    this.name = 'SABERTOOTH';

    this.fieldnames = ['drive', 'turn'];
...
mavlink.messages.sabertooth.prototype = new mavlink.message;

mavlink.messages.sabertooth.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.drive, this.turn]));
}

/* 
Voltage, Current

                voltage                   : Voltage (int16_t)
                cur_left                  : Current Left (int16_t)
                cur_right                 : Current Right (int16_t)

*/
mavlink.messages.voltagecurrent = function(voltage, cur_left, cur_right) {

    this.format = '<hhh';
    this.id = mavlink.MAVLINK_MSG_ID_VOLTAGECURRENT;
    this.order_map = [0, 1, 2];
    this.crc_extra = 143;
    this.name = 'VOLTAGECURRENT';

    this.fieldnames = ['voltage', 'cur_left', 'cur_right'];
...
mavlink.messages.voltagecurrent.prototype = new mavlink.message;

mavlink.messages.voltagecurrent.prototype.pack = function() {
    return mavlink.message.prototype.pack.call(this, this.crc_extra, jspack.Pack(this.format, [ this.voltage, this.cur_left, this.cur_right]));
}
...
mavlink.map = {
        150: { format: '<BB', type: mavlink.messages.dht11_data, order_map: [0, 1], crc_extra: 56 },
        151: { format: '<bb', type: mavlink.messages.sabertooth, order_map: [0, 1], crc_extra: 109 },
        152: { format: '<hhh', type: mavlink.messages.voltagecurrent, order_map: [0, 1, 2], crc_extra: 143 },
