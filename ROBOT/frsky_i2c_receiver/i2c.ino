...
*/
    ...
    Wire.write((uint8_t *)&i2c_dataset + receivedCommands[0], REG_MAP_SIZE+1);                 //Write up to 32 byte, since master is responsible for reading and sending NACK
...
*/
  ...
  if ((receivedCommands[0] >= 0x14) && (receivedCommands[0] <= 0x15)) { //Writeable registers above I2C_GPS_WP0  
